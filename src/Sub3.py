...
OUTPUT_FILE = os.path.join(REPO_ROOT, "Sub3")
SOURCES_FILE = os.path.join(REPO_ROOT, "SUB_SUB3")
TEMPLATE_URL = "https://raw.githubusercontent.com/Vanic24/VPN/refs/heads/main/ClashTemplate.ini"
TEXTDB_API = "https://textdb.online/update/?key=Sub3_SHFX&value={}"
...
def build_name(flag, cc, index, ipv6_tag=False):
    ...
    return f"{flag} {cc}-{index}{suffix} | Sub3"
...
def rename_node(p, country_counter, CN_TO_CC):
    ...
    if USE_ONLY_GEOIP:
        ...
        # 4️⃣ Two-letter ISO code (unit-safe)
        if not cc:
